    ...
    def _check_config_files(self):
        ...
        if not config_path.exists():
            self._add_check(CheckResult(
                ...
                fix_suggestion="Restore config from: llmc_template/config/examples/"
            ))
            return
        ...
        try:
            ...
            if missing:
                self._add_check(CheckResult(
                    ...
                    fix_suggestion="Restore config from: llmc_template/config/examples/context_profile.yaml"
                ))
            else:
                self._add_check(CheckResult(
                    name="Configuration Files",
            ...
            self._add_check(CheckResult(
                ...
                fix_suggestion="Fix YAML syntax or restore from: llmc_template/config/examples/"
            ))
        except Exception as e:
            self._add_check(CheckResult(
                name="Configuration Files",
