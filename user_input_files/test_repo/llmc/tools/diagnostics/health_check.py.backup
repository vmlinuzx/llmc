            ...
            try:
                ...
                if parser_available:
                    ...
                    self._add_check(CheckResult(
                        ...
                        fix_suggestion=f"Run: python llmc/scripts/build_tree_sitter.py"
                    ))
                ...
                self._add_check(CheckResult(
                    ...
                    fix_suggestion="Rebuild parsers: python llmc/scripts/build_tree_sitter.py"
                ))
    ...
    def _check_config_files(self):
        ...
        if not config_path.exists():
            self._add_check(CheckResult(
                ...
                fix_suggestion="Restore config from: llmc/config/examples/"
            ))
            return
        ...
        try:
            ...
            if missing:
                self._add_check(CheckResult(
                    ...
                    fix_suggestion="Restore config from: llmc/config/examples/context_profile.yaml"
                ))
            else:
                self._add_check(CheckResult(
                    name="Configuration Files",
            ...
            self._add_check(CheckResult(
                ...
                fix_suggestion="Fix YAML syntax or restore from: llmc/config/examples/"
            ))
        except Exception as e:
            self._add_check(CheckResult(
                name="Configuration Files",
