...
print_codex_wrap_help() {
  cat <<'EOF'
Usage: llmc/scripts/codex_wrap.sh [options] [prompt|prompt_file]
...
Examples:
  llmc/scripts/codex_wrap.sh --local "Fix the failing unit test"
  llmc/scripts/codex_wrap.sh --repo ../other/repo task.txt
EOF
}
