...
from llmc_agent.config import Config, OllamaConfig, RAGConfig, AgentConfig
...
async def _test_logic():
    ...
    mock_ollama.generate_with_tools.side_effect = [
        response_with_tool,
        response_final
    ]
    ...
    assert not explosive_tool_impl.detonated, \
