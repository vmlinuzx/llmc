...
"""
    ...
    def test_idempotent_reindex(self):
        ...
        try:
            ...
            # Get initial stats
            result1 = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "stats", "--json"], cwd=test_repo
            )
    ...
    def test_plan_generation(self):
        ...
        try:
            ...
            # Generate a plan
            result = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "plan", "hello world"],
                cwd=test_repo,
                timeout=30,
            )
    ...
    def test_search_basic(self):
        ...
        try:
            ...
            # Search
            result = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "search", "hello", "--json"],
                cwd=test_repo,
                timeout=30,
            )
    ...
    def test_health_check(self):
        ...
        try:
            # Run doctor command
            result = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "doctor"],
                cwd=test_repo,
                check=False,
                timeout=30,
            )
    ...
    def test_e2e_cold_start(self):
        ...
        try:
            ...
            # Step 2: search
            result = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "search", "test", "--json"],
                cwd=test_repo,
                timeout=30,
            )
    ...
    def test_error_exit_code(self):
        ...
        try:
            ...
            result = self.run(
                [sys.executable, "-m", "llmc.rag.cli", "search", "test"],
                cwd=test_repo,
                check=False,
                timeout=30,
            )
