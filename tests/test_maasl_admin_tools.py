...
class TestStompStats:
    ...
    def test_stats_docgen_tracking(self):
        ...
        assert after["docgen_operations"]["generated"] == before["docgen_operations"]["generated"] + 1
        assert after["docgen_operations"]["noop"] == before["docgen_operations"]["noop"] + 1
        assert after["docgen_operations"]["error"] == before["docgen_operations"]["error"] + 1
    ...
    def test_stats_stomp_guard_tracking(self):
        ...
        assert after["stomp_guard_calls"]["success"] == before["stomp_guard_calls"]["success"] + 1
        assert after["stomp_guard_calls"]["failed"] == before["stomp_guard_calls"]["failed"] + 1
