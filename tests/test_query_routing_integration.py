...
""")
    ...
    # Insert files
    db.conn.execute("INSERT INTO files (path, lang, file_hash, size, mtime) VALUES ('doc.md', 'markdown', 'h1', 10, 0)")
    db.conn.execute("INSERT INTO files (path, lang, file_hash, size, mtime) VALUES ('code.py', 'python', 'h2', 10, 0)")
    ...
    vec_blob = create_dummy_embedding(0.1, 64) # Value doesn't matter much with hash backend as it hashes the text
