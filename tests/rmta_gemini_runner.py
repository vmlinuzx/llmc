...
async def run_tests():
    ...
    try:
        ...
        test_cases = [
            ...
            # RAG
            {"tool": "rag_search", "args": {"query": "routing", "limit": 1}, "desc": "RAG Search"},
            {"tool": "rag_plan", "args": {"query": "how does routing work"}, "desc": "RAG Plan"},
            
            # Metrics
            {"tool": "get_metrics", "args": {}, "desc": "Get Metrics"},
            
            # Linux Ops
            {"tool": "linux_proc_list", "args": {"max_results": 5}, "desc": "List Processes"},
            {"tool": "linux_sys_snapshot", "args": {}, "desc": "Sys Snapshot"},
            
            # Broken/Missing checks (Intentional Failures)
            {"tool": "non_existent_tool", "args": {}, "desc": "Missing Tool Check", "expect_error": True},
            
            # FS Write (Test Safety)
            {"tool": "linux_fs_mkdir", "args": {"path": "rmta_test_dir"}, "desc": "Mkdir", "expected_missing": True},
            {"tool": "linux_fs_write", "args": {"path": "rmta_test_dir/test.txt", "content": "Hello"}, "desc": "Write File", "expected_missing": True},
        ...
        for test in test_cases:
            ...
            try:
                if tool_name == "non_existent_tool":
                    ...
                    try:
                        await client.send_request("tools/call", {"name": tool_name, "arguments": test["args"]})
                    ...
                    if is_soft_error:
                        test_result["status"] = "buggy" # Or broken depending on severity
                    else:
