...
class Judge:
    ...
    def _check_metamorphic(self, prop, events: list[TraceEvent]):
                ...
                if e["event"] == "tool_call" and e.get("tool_name") == "rag_search":
                    ...
                    if q == query:
                        ...
                        for j in range(i + 1, len(events)):
                            next_e = events[j]
                            if (
                                next_e["event"] == "tool_result"
                                and next_e["tool_name"] == "rag_search"
                            ):
        ...
        context = {"result_count": result_count, "results": results, "jaccard": jaccard}
                ...
                self.incidents.append(
                    {
                        ...
                        "severity": self.scenario.severity_policy.property_failures.get(
                            prop.name, "P2"
                        ),
