...
from llmc.rag.graph_index import (
...
from llmc.rag.graph_stitch import Neighbor, expand_search_items
...
def _graph_path(repo_root: Path | str) -> Path:
    ...
    """
    from llmc.rag import _graph_path as _core_graph_path
...
def build_graph_for_repo(repo_root: Path | str):
    ...
    """
    from llmc.rag import build_graph_for_repo as _core_build_graph_for_repo
    from llmc.rag.schema import build_graph_for_repo as _schema_build_graph_for_repo
