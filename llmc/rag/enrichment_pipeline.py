   ...
   Usage:
    ...
    def _process_span(self, slice_view: EnrichmentSliceView, span_number: int = 0) -> EnrichmentResult:
        ...
        try:
            ...
            self._write_enrichment(slice_view.span_hash, result, meta, slice_view=slice_view)
    ...
    def _is_tech_docs_content(
        ...
        """
        # Check content_type
        content_type = slice_view.content_type.lower() if slice_view.content_type else ""
        ...
        tech_docs_fields = ("related_topics", "prerequisites", "warnings", "key_concepts")
