...
def find_span_by_topic(
    ...
    possible_paths = [
        ...
        topic.replace(" ", "_")
        + ".md",  # "Installation Guide" -> "Installation_Guide.md"
        topic.replace(" ", "-")
        + ".md",  # "Installation Guide" -> "Installation-Guide.md"
    ]
        ...
        try:
            ...
            """,
                (
                    ...
                    target_text,
                    (
                        confidence_base if target_hash else confidence_base * 0.5
            ...
            errors.append(
                f"Failed to create {edge_type.value} edge for '{target_text}': {e}"
            )
