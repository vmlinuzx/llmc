...
class ContextTrimmer:
    ...
    def trim_to_budget(
        self, chunks: list[ChunkItem], query: str = ""
    ...
    def _apply_mmr(
        self, chunks: list[ChunkItem], query: str, top_k: int | None = None
    ) -> list[ChunkItem]:
...
def search_with_trimming(
    ...
    *,
    ...
    Example:
        >>> chunks, stats = search_with_trimming("authentication logic", max_tokens=4096, limit=30)
