...
from llmc.rag.quality import format_quality_summary, run_quality_check
from llmc.rag.runner import detect_changes, run_embed, run_sync
    ...
    def run_rag_cli(self, repo: Path, command: list) -> tuple[bool, str]:
        ...
        try:
            result = subprocess.run(
                ["python3", "-m", "llmc.rag.cli"] + command,  # Fixed: python -> python3
                check=False,
                cwd=repo,
                capture_output=True,
                text=True,
