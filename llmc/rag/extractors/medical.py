...
from .medical_segmenter import segment_note
...
class MedicalExtractor:
    def __init__(self):
        ...
        if NLP_AVAILABLE:
            try:
                ...
                self.nlp = spacy.load(
                    "en_core_sci_sm"
                )  # Assumption: installed if NLP_AVAILABLE
            except Exception:
                pass
    ...
    def _extract_meds(self, text: str) -> list[dict[str, Any]]:
        ...
        for line in lines:
            ...
            if len(parts) >= 2:
                ...
                meds.append(
                    {"name": name, "raw": line.strip(), "source": "regex_fallback"}
                )
        return meds
    ...
    def _extract_labs(self, text: str) -> list[dict[str, Any]]:
        ...
        for line in lines:
            ...
            if match:
                ...
                if key.lower() in ["am", "pm"]:
                    continue  # False positive time
    ...
    def _extract_diagnoses(self, text: str) -> list[dict[str, Any]]:
        ...
        for line in lines:
            ...
            if clean:
                diags.append({"term": clean, "context": {}})  # Default
        return diags
