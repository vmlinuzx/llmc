...
HEADER_VARIANTS: Dict[str, List[str]] = {
    SECTION_SUBJECTIVE: [
        "subjective", "history of present illness", "hpi", "chief complaint", "cc", 
        "reason for visit", "review of systems", "ros"
    ],
    SECTION_OBJECTIVE: [
        "objective", "physical exam", "pe", "vitals", "vital signs", 
        "measurements", "exam"
    ],
    SECTION_ASSESSMENT: [
        "assessment", "assessment and plan", "a/p", "diagnosis", "diagnoses", 
        "impression", "clinical impression", "problem list"
    ],
    SECTION_PLAN: [
        "plan", "treatment plan", "recommendations", "follow up", "disposition"
    ],
    SECTION_HISTORY: [
    ...
    SECTION_MEDICATIONS: [
        "medications", "current medications", "meds", "active medications", 
        "discharge medications"
    ],
    SECTION_ALLERGIES: [
        "allergies", "allergies/intolerances", "all"
    ],
    SECTION_LABS: [
        "labs", "laboratory results", "lab results", "studies"
    ],
    SECTION_IMAGING: [
        "imaging", "radiology", "studies", "x-ray", "mri", "ct"
    ],
    SECTION_FINDINGS: [
