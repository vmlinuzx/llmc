...
def main():
    ...
    try:
        ...
        assert hasattr(
            OllamaBackend, "__enter__"
        ), "Missing __enter__ (context manager)"
        ...
        assert hasattr(
            EnrichmentPipeline, "process_batch"
        ), "Missing process_batch method"
        assert hasattr(
            EnrichmentPipeline, "_get_pending_spans"
        ), "Missing _get_pending_spans"
        ...
        assert hasattr(
            EnrichmentPipeline, "_write_enrichment"
        ), "Missing _write_enrichment"
        ...
        assert is_dataclass(
            EnrichmentBatchResult
        ), "EnrichmentBatchResult is not a dataclass"
