...
class MedicalEvaluator:
    ...
    def compute_recall_at_k(self, predictions: List[List[str]], 
        ...
        if len(predictions) != len(ground_truth):
            raise ValueError("Number of prediction lists must match number of ground truth lists")
    ...
    def compute_mrr(self, predictions: List[List[str]], 
    ...
    def compute_precision_at_k(self, predictions: List[List[str]], 
                              ground_truth: List[List[str]], 
                              k: int = 10) -> float:
        """
    ...
    def compute_average_precision(self, predictions: List[List[str]], 
                                 ground_truth: List[List[str]]) -> float:
        """
